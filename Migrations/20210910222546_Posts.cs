        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioIdPost = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Postagem", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Postagem_AspNetUsers_UsuarioIdPost",
                        column: x => x.UsuarioIdPost,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioIdComentario = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comentario_AspNetUsers_UsuarioIdComentario",
                        column: x => x.UsuarioIdComentario,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comentario_UsuarioIdComentario",
                table: "Comentario",
                column: "UsuarioIdComentario");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Postagem_UsuarioIdPost",
                table: "Postagem",
                column: "UsuarioIdPost");
        }
